...
namespace Web202209.SAP_RareCoinWholesalers.Services.Deposits
{
	/// <summary>
	/// CheckLine service interface
	/// </summary>
	public interface ICheckLineService
	{
		/// <summary>
		/// Truncates the [Import].[Deposit_CheckLine] table.
		/// </summary>
		void TruncateTable();
		/// <summary>
