...
{
	public partial class BusinessPartnerRequest : BaseRequest
	{
		...
		public BusinessPartnerRequest() { }

		public BusinessPartnerRequest(string cardCode)
		{
			CardCode = cardCode;
		}

		public BusinessPartnerRequest(BusinessPartner x)
		{
			BPIntrastatExtension = x.BPIntrastatExtension;
			BPAddresses = x.BPAddresses;
			BPPaymentMethods = x.BPPaymentMethods;
			ContactEmployees = x.ContactEmployees;
			BPAccountReceivablePaybleCollection = x.BPAccountReceivablePaybleCollection;
			BPBankAccounts = x.BPBankAccounts;
			BPBlockSendingMarketingContents = x.BPBlockSendingMarketingContents;
			BPBranchAssignment = x.BPBranchAssignment;
			BPCurrenciesCollection = x.BPCurrenciesCollection;
			BPFiscalTaxIDCollection = x.BPFiscalTaxIDCollection;
			BPPaymentDates = x.BPPaymentDates;
			BPWithholdingTaxCollection = x.BPWithholdingTaxCollection;
			DiscountGroups = x.DiscountGroups;
