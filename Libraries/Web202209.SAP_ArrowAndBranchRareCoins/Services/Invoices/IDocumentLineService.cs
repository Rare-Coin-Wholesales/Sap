...
namespace Web202209.SAP_ArrowAndBranchRareCoins.Services.Invoices
{
	/// <summary>
	/// Invoice_DocumentLine service interface
	/// </summary>
	public interface IDocumentLineService
	{
		/// <summary>
		/// Truncates the [Import].[Invoice_DocumentLine] table.
		/// </summary>
		void TruncateTable();
		/// <summary>
