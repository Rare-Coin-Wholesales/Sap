...
namespace Sap.ApiToScarAabwMapper
{
	...
	{
		public virtual JournalEntry ToSql(Api.Domain.JournalEntries.JournalEntry x)
		{
		...
		public virtual JournalEntryLine ToSql(Api.Domain.JournalEntries.JournalEntryLine x)
		{
