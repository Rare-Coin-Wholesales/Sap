...
namespace Web202209.SAP_ArrowAndBranchWinery.Services
{
	/// <summary>
	/// Base service
	/// </summary>
	public abstract partial class BaseService
	{
		...
		public BaseService()
		{
			...
			_connectionString = _encryptionUtil.Decrypt(CommonUtil.GetEnvironmentVariable("Web202209.SAP_ArrowAndBranchWinery"));
			_dbContext = new SAP_ArrowAndBranchWineryDb(_connectionString);
		}
