...
{
	/// <summary>
	/// DocumentLine service
	/// </summary>
	public partial class DocumentLineService : BaseService
	{
		/// <inheritdoc/>
		public virtual void Insert(DocumentLine x)
		{
			#region Input check
			if (x == null)
			...
			try {
				_dbContext.DocumentLines.Add(x);
		...
		{
			base.TruncateTable("DocumentLine");
		}
	}
}