...
namespace Web202209.SAP_ArrowAndBranchRareCoins.Services.PurchaseInvoices
{
	/// <summary>
	/// PurchaseInvoice_DocumentLine service interface
	/// </summary>
	public interface IDocumentLineService
	{
		/// <summary>
		/// Truncates the [Import].[PurchaseInvoice_DocumentLine] table.
		/// </summary>
		void TruncateTable();
		/// <summary>
