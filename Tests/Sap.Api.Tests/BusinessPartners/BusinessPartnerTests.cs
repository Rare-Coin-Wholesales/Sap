...
{
	public partial class BusinessPartnerTests
	{
		...
		/// </summary>
		[Fact]
		public async Task Test_CreateMissingInvoiceUnixCustomers()
		{
		...
		/// </summary>
		[Fact]
		public async Task Test_CreateMissingOrderUnixCustomers()
		{
			_testServiceLayer.AddErrorLogs();
