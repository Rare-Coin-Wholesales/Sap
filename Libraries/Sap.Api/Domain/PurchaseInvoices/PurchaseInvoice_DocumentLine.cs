...
{
	public partial class PurchaseInvoice_DocumentLine : BaseEntity
	{
		#region Fields
		...
		[JsonProperty("ImportProcesses")]
		public IList<object> ImportProcesses;

		[JsonProperty("GeneratedAssets")]
		public IList<object> GeneratedAssets;
		...
		public PurchaseInvoice_DocumentLine()
		{
			...
			GeneratedAssets = new List<object>();
			ImportProcesses = new List<object>();
