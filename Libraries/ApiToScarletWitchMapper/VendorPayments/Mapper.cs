...
namespace ApiToScarletWitchMapper
{
	...
	{
		public virtual PaymentCheck ToSql(Sap.Api.Domain.VendorPayments.PaymentCheck x)
		{
		...
		public virtual PaymentInvoice ToSql(Sap.Api.Domain.VendorPayments.PaymentInvoice x)
		{
