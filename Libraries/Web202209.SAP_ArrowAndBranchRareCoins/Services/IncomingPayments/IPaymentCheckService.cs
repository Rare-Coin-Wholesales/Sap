...
namespace Web202209.SAP_ArrowAndBranchRareCoins.Services.IncomingPayments
{
	/// <summary>
	/// PaymentCheck service interface
	/// </summary>
	public interface IPaymentCheckService
	{
		/// <summary>
		/// Truncates the [Import].[IncomingPayment_PaymentCheck] table.
		/// </summary>
		void TruncateTable();
		/// <summary>
