...
{
	/// <summary>
	/// TaxExtension service
	/// </summary>
	public partial class TaxExtensionService : BaseService
	{
		/// <inheritdoc/>
		public virtual void Insert(TaxExtension x)
		{
			#region Input check
			if (x == null)
			...
			try {
				_dbContext.TaxExtensions.Add(x);
		...
		{
			base.TruncateTable("TaxExtension");
		}
	}
}