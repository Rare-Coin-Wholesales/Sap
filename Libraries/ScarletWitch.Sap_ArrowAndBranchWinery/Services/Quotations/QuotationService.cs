...
namespace ScarletWitch.Sap_ArrowAndBranchWinery.Services.Quotations
{
	...
	/// Quotation service
	/// </summary>
	public partial class QuotationService : BaseService, IQuotationService
	{
		/// <inheritdoc/>
		public virtual void Insert(Quotation x)
		{
			#region Input check
			if (x == null)
