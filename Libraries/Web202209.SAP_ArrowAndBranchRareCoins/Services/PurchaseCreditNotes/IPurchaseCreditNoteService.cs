...
namespace Web202209.SAP_ArrowAndBranchRareCoins.Services.PurchaseCreditNotes
{
	/// <summary>
	...
	{
		/// <summary>
		/// Transfers [PurchaseCreditNote] to [dbo].
		/// </summary>
		void TransferToDbo();
		/// <summary>
		/// Truncates the [Import].[PurchaseCreditNote] table.
		/// </summary>
		void TruncateTable();
		/// <summary>
