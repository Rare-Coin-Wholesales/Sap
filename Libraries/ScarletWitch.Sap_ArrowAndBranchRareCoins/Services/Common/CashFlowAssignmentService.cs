...
{
	/// <summary>
	/// CashFlowAssignment service
	/// </summary>
	public partial class CashFlowAssignmentService : BaseService
	{
		/// <inheritdoc/>
		public virtual void Insert(CashFlowAssignment x)
		{
			#region Input check
			if (x == null)
			...
			try {
				_dbContext.CashFlowAssignments.Add(x);
		...
		{
			base.TruncateTable("CashFlowAssignment");
		}
	}
}