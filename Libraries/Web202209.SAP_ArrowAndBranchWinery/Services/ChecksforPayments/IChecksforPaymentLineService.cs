...
namespace Web202209.SAP_ArrowAndBranchWinery.Services.ChecksforPayments
{
	/// <summary>
	/// ChecksforPaymentLine service interface
	/// </summary>
	public interface IChecksforPaymentLineService
	{
		/// <summary>
		/// Truncates the [Import].[ChecksforPaymentLine] table.
		/// </summary>
		void TruncateTable();
		/// <summary>
